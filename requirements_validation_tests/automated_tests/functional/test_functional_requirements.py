"""
Black-box functional requirement validation.

Drives the copilot through the CLI the source document requires and inspects its observable output. These are the Section 5.1 acceptance criteria that describe behaviour rather than structure.
...
the "functional" slice of that registry to pytest.
"""
