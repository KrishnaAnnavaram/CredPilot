...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Lifecycle controls and evidence' - agency requirements include acceptable title and the required lien priority.
