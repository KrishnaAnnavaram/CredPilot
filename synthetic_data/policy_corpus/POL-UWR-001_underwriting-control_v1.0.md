...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Human-in-the-loop classification' - the recommended synthetic control policy for which cases require human review.
...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Lifecycle controls and evidence' - new information can require recalculation and resubmission.
