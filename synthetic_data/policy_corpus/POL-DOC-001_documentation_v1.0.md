...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Document catalog' - a letter of explanation must be corroborated where required and is not self-validating.
...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Data lineage' - lineage must remain queryable at field level.
