...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Missing/conflicting data workflow' - an application start date differing from the verification requires an authoritative timeline and a condition if unresolved.
