...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Income model' - rental evidence is tax returns, lease, appraisal or rental analysis depending on the case; unsupported leases and related-party arrangements are the principal risks.
