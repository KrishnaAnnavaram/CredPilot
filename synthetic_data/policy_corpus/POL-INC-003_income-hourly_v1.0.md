...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Income model' - falling hours are the principal risk for variable hourly income.
