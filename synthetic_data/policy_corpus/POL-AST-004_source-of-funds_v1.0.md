...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Asset model' - agency gift eligibility differs by occupancy and purpose, and gifts are generally not permitted on investment-property transactions.
...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Missing/conflicting data workflow' - a large deposit with no source is conditioned and risk-flagged, and is not automatically counted.
