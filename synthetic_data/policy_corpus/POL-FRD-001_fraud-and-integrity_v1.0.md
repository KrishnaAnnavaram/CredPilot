...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Human-in-the-loop classification' - suspected document manipulation requires human or fraud review because the AI should not clear itself.
...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Regulatory and agency landscape' - the CFPB has stated that adverse-action requirements do not disappear because a creditor uses a complex algorithm.
