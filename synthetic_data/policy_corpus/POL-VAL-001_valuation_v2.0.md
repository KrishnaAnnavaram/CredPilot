...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Property valuation' - for eligible transactions the agency automated system can offer value acceptance and the offer controls; the eligibility conditions here are synthetic.
...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Property valuation' - UAD 3.6 entered broad production in January 2026 and is scheduled to become mandatory on 2 November 2026, so policy metadata must support both eras.
