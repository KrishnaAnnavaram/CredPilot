...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Income model' - fixed salary is converted to monthly income; pay frequency is an explicit edge case.
...
**Basis.** Completed research report, `synthetic_data/research/deep-research-report.md`, 'Document catalog' - digital validation services can reduce document requirements without removing the obligation to address contradictory information.
