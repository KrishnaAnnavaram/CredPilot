...
#: The mortgage dataset is one product folder under synthetic_data/, so the
#: repository root is two levels above SYNTH_ROOT, not one.
REPO_ROOT = SYNTH_ROOT.parents[1]
