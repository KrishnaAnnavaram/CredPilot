...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Underwriting calculations' - cash to close is a deterministic settlement calculation that must reconcile to the disclosures.
...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Human-in-the-loop classification' - a mathematical funds-to-close shortfall with no permissible cure is a hard policy failure.
