...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Underwriting calculations' - purchase LTV uses the lower of sales price or appraised value; the thresholds themselves are synthetic.
...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Asset model' - agency gift eligibility differs by occupancy and purpose; the percentages here are synthetic.
