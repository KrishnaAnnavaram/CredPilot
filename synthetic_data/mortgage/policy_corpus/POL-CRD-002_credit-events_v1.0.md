...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Underwriting calculations' - derogatory seasoning depends on the event type and the correct anchor date; the periods here are synthetic.
