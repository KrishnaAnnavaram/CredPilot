...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Income model' - a future AI must not penalise income simply because it comes from Social Security, retirement or another public-assistance source.
...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Income model' and 'Regulatory and agency landscape' - Regulation B restricts requests about support obligations and the borrower's reliance is elective.
