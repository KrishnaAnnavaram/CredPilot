...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Underwriting calculations' - reserves are conventionally expressed as months of qualifying PITIA remaining after required funds-to-close are deducted.
...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Underwriting calculations' - multiple financed properties can alter the reserve requirement.
