...
**POL-CRD-001 · version 1.0 · effective 2026-01-01**
...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Regulatory and agency landscape' - FCRA permissible purpose and adverse-action duties.
...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Liability/credit model' - representative-score methodology must be preserved; agency casefiles do not apply a single published minimum in the same way manual underwriting does.
...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Regulatory and agency landscape' and 'Income model' - ECOA / Regulation B 12 CFR 1002.6 evaluation rules and the prohibition on discounting public-assistance income.

### CRD-SCR-003 — Minimum representative score

- **Source category:** `SYNTHETIC_INTERNAL_POLICY` · **Severity:** `HARD_FAIL` · **Outcome:** `PASS_FAIL`

**Applies when.** All applications within this document's scope.

The representative score must be at least 620 for a conventional conforming transaction, regardless of leverage. Government programme overlays set their own floors and govern for their own programmes.
...
The credit report must be no older than 120 days on the note date. A report older than that is refreshed rather than extrapolated, because new obligations appearing after the report date change the debt-to-income calculation.
...
| --- | --- | --- |
| 1.0 | 2026-01-01 | Original credit standard: a flat 620 floor for conventional transactions. Superseded on 2026-07-01. |
| (later) | from 2026-07-01 | This version is superseded by POL-CRD-001 v2.0. |
