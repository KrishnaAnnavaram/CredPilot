...
**Basis.** Completed research report, `synthetic_data/mortgage/research/deep-research-report.md`, 'Property valuation' - agency automated systems can offer value acceptance for eligible transactions, so a dataset needs a valuation_method field rather than a mandatory appraisal assumption.
