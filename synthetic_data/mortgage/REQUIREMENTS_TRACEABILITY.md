...
| SDR-A18 | "A claim with no committed evidence scores zero; an evidence artifact with no producing code … is heavily discounted." | `requirements_verbatim.md` | REQ-029, Evidence-in-Repo Rule | Data and the code that produced it both committed | The generator sits in `synthetic_data/mortgage/generator/`, directly beside the output it produces; nothing here was produced by hand |
