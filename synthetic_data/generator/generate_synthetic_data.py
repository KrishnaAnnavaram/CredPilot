...
Writes:
    synthetic_data/policy_corpus/        42 versioned policy documents
    synthetic_data/applications/         the input packets the copilot reads
    synthetic_data/structured/           32 relational tables
    synthetic_data/profiles/             borrower and application profiles
    synthetic_data/policy_metadata/      policy and rule catalogues
    synthetic_data/applicant_documents/  one folder per application
    synthetic_data/scenarios/            scenario_catalog.json
    synthetic_data/golden_set/           evaluation cases and expected results
    synthetic_data/schemas/              JSON Schemas
"""
...
def main() -> int:
    ...
    u.write_json(
        u.APPLICATION_INPUT_DIR / "index.json",
        {
            ...
            "note": (
                ...
                "these files; ground truth lives in synthetic_data/golden_set/."
            ),
    ...
    print()
    print("Next: python synthetic_data/generator/validate_synthetic_data.py")
    return 0
