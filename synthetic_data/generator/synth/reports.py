...
def data_dictionary() -> str:
    ...
    for folder, paths in sources:
        lines.append(f"## `synthetic_data/{folder}/`")
        lines.append("")
        for path in paths:
            name = path.stem
...
def final_report(seed: int, catalog: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "| Document | Role |",
        "| --- | --- |",
        "| `synthetic_data/research/deep-research-report.md` | The completed Deep "
        ...
        "",
        "`synthetic_data/research/deep-research-report.md` is a completed research "
        ...
        "",
        "See `synthetic_data/REQUIREMENTS_TRACEABILITY.md` for the full table. Every "
        ...
        "",
        "See `synthetic_data/DESIGN_ASSUMPTIONS.md`. Every assumption is recorded there "
        ...
        "## 23-24. Validation",
        "",
        "Run `python synthetic_data/generator/validate_synthetic_data.py`. The "
        "validator executes "
        ...
        "`synthetic_data/POLICY_TEST_COVERAGE.md` for the rule-level matrix, including "
        "which rules have positive, boundary and negative cases.",
        "",
        "## 26. Scenario coverage",
        "",
        "See `synthetic_data/SCENARIO_COVERAGE.md`. Every recommendation value in the "
        ...
        f"SYNTHETIC_SEED={seed} python synthetic_data/generator/generate_synthetic_data.py",
        "",
