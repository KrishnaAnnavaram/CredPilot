...
never share a file.** Nothing under `synthetic_data/applications/` holds an expected
decision, an expected rule id or an expected risk flag, because those files are what
the agent is given. Expectations live only under `synthetic_data/golden_set/`.
"""
        ...
        rows.append(
            {
                ...
                "relative_path": f"synthetic_data/policy_corpus/{policy.filename}",
        ...
        meta.append(
            {
                ...
                "relative_path": (
                    f"synthetic_data/applicant_documents/{app_id}/{doc.filename}"
                ),
        ...
        "supplied_documents": [
            {
                ...
                "relative_path": (
                    f"synthetic_data/applicant_documents/"
...
def golden_case(
    ...
    case = {
        ...
        "input_packet": f"synthetic_data/applications/{app_id}.json",
        "document_folder": f"synthetic_data/applicant_documents/{app_id}",
        "question": (
    ...
    return {
        "application.schema.json": {
            ...
            "description": (
                ...
                "ground truth lives in synthetic_data/golden_set/."
            ),
            "type": "object",
            "required": [
        ...
        "golden_case.schema.json": {
            ...
            "description": (
                ...
                "synthetic_data/README.md on data leakage."
            ),
            "type": "object",
            "required": [
